...
const ARTICLES = [
  {
    ...
    excerpt: "Uma análise técnica sobre valorização, demografia e infraestrutura no Litoral Norte gaúcho — e por que o momento atual merece atenção estratégica.",
    image: "/blog1_new.png",
    icon: <TrendingUp size={14} />,
    href: "/blog/investir-capao-da-canoa",
  },
  {
    category: "Curadoria",
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-20 lg:gap-32">
          {ARTICLES.map((article, idx) => (
            <Link key={idx} href={article.href} className="flex flex-col group cursor-pointer">
              <article className="flex flex-col flex-grow">
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center gap-6 text-primary group-hover:text-secondary transition-all duration-300">
