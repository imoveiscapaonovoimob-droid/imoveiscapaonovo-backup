...
// ── Helpers (mesmo padrão visual de NewPropertyForm/EditPropertyForm) ──────────
...
export default function NewCondominiumForm() {
  ...
  return (
    <div className="min-h-screen bg-white py-20 px-8 lg:px-24">
      <div className="max-w-4xl mx-auto mb-16">
        ...
        <h1 className="font-noto text-5xl text-[#002B49] mb-3 tracking-tighter">Novo Condomínio</h1>
        <p className="font-manrope text-sm text-[#002B49]/40 tracking-widest uppercase">Cadastro de Empreendimento</p>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <div className="flex justify-end gap-4 pt-8 border-t border-[#002B49]/5">
          ...
          >
            {loading ? (uploadStatus || `Salvando ${uploadProgress}%`) : 'Salvar Condomínio'}
          </button>
        </div>
      </div>
    </div>
