      ...
      <section className="py-16 px-6 lg:px-10 max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <details className="p-4 border border-secondary/20 bg-white rounded-lg">
            ...
            <p className="mt-4 text-secondary">Completamente. Capão Novo oferece uma qualidade de vida ímpar, segurança 24h em seus condomínios de ponta e constante valorização imobiliária graças à nova onda de investimentos infraestruturais gaúchos no Litoral Norte.</p>
          </details>
          <details className="p-4 border border-secondary/20 bg-white rounded-lg">
            <summary className="font-bold cursor-pointer text-primary">Qual o melhor lugar de Capão Novo para investir?</summary>
            <p className="mt-4 text-secondary">Depende de sua necessidade: Capão Novo Posto 4 entrega ótima mobilidade; Capão Novo Village traz conforto e calmaria; Já para padrão "resort", Costa Serena e Velas da Marina figuram entre os mais luxuosos de todo RS. Nós da imobiliária temos acesso a todos.</p>
          </details>
        </div>
      </section>
