...
export const metadata: Metadata = {
  title: "Terreno Comercial em Capão Novo RS | Lotes à Venda",
  description: "Terrenos comerciais em Capão Novo RS. Localizações estratégicas, alto fluxo e potencial de retorno acima da média. Análise técnica e jurídica completa.",
  keywords: ["terreno comercial capão novo", "lote comercial capão novo rs", "ponto comercial capão novo litoral norte"],
};
      ...
      <section className="pt-40 pb-16 px-6 lg:px-10 max-w-[1200px] mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-serif text-primary leading-tight mb-8">
            Terreno comercial em <em className="italic font-normal text-secondary">Capão Novo RS</em>
          </h1>
          <p className="text-xl text-primary/70 font-sans leading-relaxed mb-6">
            O crescimento de Capão Novo como polo turístico e residencial no litoral norte gaúcho criou uma demanda crescente por espaços comerciais. Um <strong>terreno comercial em Capão Novo RS</strong> representa uma oportunidade rara em um mercado ainda com preços competitivos e alto potencial de retorno.
          </p>
          <p className="text-lg text-primary/60 font-sans leading-relaxed mb-10">
            <strong>Lotes comerciais em Capão Novo</strong> bem localizados — próximos às avenidas principais, zona turística ou regiões de alto fluxo — são ativos de máxima valorização. Seja para construir, locar ou incorporar, a oportunidade está agora.
          </p>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
            {["Localizações estratégicas com alto fluxo","Crescimento do turismo impulsiona comércio","Retorno por locação ou venda futura","Mercado em expansão com poucos concorrentes","Análise técnica e jurídica completa","Viabilidade de instalação imediata"].map(item => (
          ...
          <a href={WHATSAPP_MESSAGES.investir} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-5 bg-secondary text-white text-xs font-bold uppercase tracking-[0.2em] rounded hover:bg-secondary/90 transition-all duration-300 shadow-xl mb-16">
            <MessageCircle size={18} />Ver terrenos comerciais disponíveis
          </a>
